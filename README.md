...
1. 下载插件包：`web-video-recorder-extension.zip`
2. 在Chrome扩展程序页面加载插件
3. 点击插件图标开始录制
4. 在插件管理页面查看和下载视频
...
└── web-video-recorder-extension.zip  # 插件包
```
...
### Chrome插件
1. 下载 `web-video-recorder-extension.zip`
2. 解压到本地文件夹
...
详细隐私政策请查看 [privacy_policy.html](privacy_policy.html)
